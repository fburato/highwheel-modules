...
public final class Access {
    ...
    private Access(final AccessPoint source, final AccessPoint dest, final AccessType type) {
        this.type = type;
        this.dest = dest;
        this.source = source;
    }

    public static Access create(final AccessPoint source, final AccessPoint dest, final AccessType type) {
