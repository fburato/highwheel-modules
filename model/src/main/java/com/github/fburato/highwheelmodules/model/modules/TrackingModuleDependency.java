...
public final class TrackingModuleDependency {
    ...
    public TrackingModuleDependency(final HWModule source, final HWModule dest) {
        this.source = source;
        this.dest = dest;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(source, that.source) && Objects.equals(dest, that.dest)
