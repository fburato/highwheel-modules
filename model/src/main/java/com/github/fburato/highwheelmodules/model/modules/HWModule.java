...
public final class HWModule {
    ...
    public String toString() {
        return "HWModule{" + "name='" + name + '\'' + ", patternLiteral='" + patternLiterals + '\'' + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, module.name) && Objects.equals(this.patternLiterals, module.patternLiterals);
    }
