...
import com.github.fburato.highwheelmodules.model.Definition;
import com.github.fburato.highwheelmodules.model.Module;
...
import static org.pitest.highwheel.highwheelmodules.utils.StringUtil.join;
...
public class ModuleAnalyserTest {
    ...
    private static AnalyserModel.DependencyViolation depV(String source, String dest, List<String> specPath, List<String> actualPath) {
