...
class GuavaModuleGraphSest extends AnyWordSpec with Matchers with OneInstancePerTest {
  ...
  "addDependency" should {
    "add edge to network" in {
      testee.addModule(m1)
      testee.addModule(m2)
      testee.addDependency(ModuleDependency(m1, m2))
  ...
  "fanIn of module" should {
    ...
    "equal the amount of incoming edges" in {
      ...
      testee.addModule(m2)
      testee.addModule(m3)
      testee.addDependency(ModuleDependency(m2, m1))
      testee.addDependency(ModuleDependency(m3, m1))
    ...
    "ignore self references" in {
      ...
      testee.addModule(m2)
      testee.addDependency(ModuleDependency(m1, m2))
      testee.addDependency(ModuleDependency(m2, m2))
  ...
  "fanOut of module" should {
    ...
    "equal the amount of outgoing edges" in {
      ...
      testee.addModule(m3)
      testee.addDependency(ModuleDependency(m1, m2))
      testee.addDependency(ModuleDependency(m1, m3))
    ...
    "ignore self references" in {
      ...
      testee.addModule(m2)
      testee.addDependency(ModuleDependency(m1, m2))
      testee.addDependency(ModuleDependency(m1, m1))
