...
public class AnalysisUtils {
  ...
  public static List<List<Pair<String, String>>> getEvidence(ModuleGraph<TrackingModuleDependency> trackingGraph, HWModule source, List<HWModule> path) {
    ...
    for (int i = 0; i < completePath.size() - 1; ++i) {
      ...
      maybeDep.ifPresent( dependency -> dependency.getSources().forEach((apSource) ->
