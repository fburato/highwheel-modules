...
public class GuavaGraphFactory implements ModuleGraphFactory {
  @Override
  public GuavaModuleGraph buildMetricModuleGraph() {
    return new GuavaModuleGraph(NetworkBuilder.directed().allowsSelfLoops(true).build());
  }

  @Override
  public GuavaEvidenceModuleGraph buildEvidenceModuleGraph(ModuleGraph<TrackingModuleDependency> trackingGraph, Optional<Integer> evidenceLimit) {
