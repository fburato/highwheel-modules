...
public class AnalysisState {
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof AnalysisState))
            return false;
        AnalysisState that = (AnalysisState) o;
        return Objects.equals(specGraph, that.specGraph) && Objects.equals(actualGraph, that.actualGraph)
    ...
    public String toString() {
        return "AnalysisState{" + "specGraph=" + specGraph + ", actualGraph=" + actualGraph + ", visitor=" + visitor
                + ", other=" + other + '}';
    }
}
