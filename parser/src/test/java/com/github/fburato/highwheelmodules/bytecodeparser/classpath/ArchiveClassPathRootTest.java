...
public class ArchiveClassPathRootTest {
    ...
    public void classNamesShouldReturnAllClassNamesIArchive() {
        final Collection<ElementName> expected = Arrays.asList(ElementName.fromString("injar.p1.P1NoTest$InnerTest"),
    ...
    public void getDataShouldReturnInputStreamForAKnownClass() throws Exception {
        assertThat(this.testee.getData(ElementName.fromString("injar.p1.P1Test"))).isNotNull();
    }
